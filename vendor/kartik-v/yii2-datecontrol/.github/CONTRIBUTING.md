Contributing to yii2-datecontrol
================================
Looking to contribute something to yii2-datecontrol? **Here's how you can help.**
...
[extension documentation](http://demos.krajee.com/datecontrol), 
[extension demos](http://demos.krajee.com/datecontrol-demo) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-datecontrol
------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-datecontrol_.
...
- What version of jQuery are you using? And what version of yii2-datecontrol?
- Are you using yii2-datecontrol with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-datecontrol
------------------------------------------
Before starting work on a major feature for yii2-datecontrol, **read the
[documentation](http://demos.krajee.com/datecontrol)  first** or you may risk spending a considerable amount of
...
yii2-datecontrol regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-datecontrol that contain test cases and
...
[issue-tracker]: https://github.com/kartik-v/yii2-datecontrol/issues
[licensing]: https://github.com/kartik-v/yii2-datecontrol/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-datecontrol
[requesting-features]: #requesting-features-in-yii2-datecontrol